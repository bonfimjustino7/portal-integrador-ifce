...
const CalendarGeneratedSchedules = () => {
    ...
    const handleCalendarClick = (calendarId, calendarName) => {
        ...
        navigate(`/${user}/horarios-gerados/${calendarId}`, { state: { calendarName } });
    };
            ...
            {filteredCalendars.length === 0 ? (
                <Box sx={{ textAlign: 'center', mt: 6 }}>
                    ...
                    <Typography
                        ...
                        sx={{ fontSize: { xs: 15, sm: 17 }, color: '#555' }}
                    >
                        É necessário gerar e salvar um horário para que os calendários sejam exibidos.
                    </Typography>
                </Box>
            ) : (
                <>
                    ...
                    >
                        Selecione um calendário abaixo para visualizar os horários gerados e armazenados no sistema.
                    </Typography>
                    <Grid
                        container
...
export default CalendarGeneratedSchedules;